    ...
    let resp = await fetch(url1 + userId, {
        ...
        .then(data => {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var fSubmitted = convertTimestampToDate(submitted);//("0" + (tsSubmitted.getMonth() + 1)).slice(-2) + '/' + ("0" + tsSubmitted.getDate()).slice(-2) + '/' + tsSubmitted.getFullYear();
